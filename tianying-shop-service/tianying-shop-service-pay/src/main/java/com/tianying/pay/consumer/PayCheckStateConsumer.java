package com.tianying.pay.consumer;
...
public class PayCheckStateConsumer {
	...
	public void process(Message message, @Headers Map<String, Object> headers, Channel channel) throws IOException {
		try {
			...
			if (paymentStatus.equals(com.tianying.pay.constant.PayConstant.PAY_STATUS_SUCCESS)) {
			...
			int updatePaymentStatus = paymentTransactionMapper.updatePaymentStatus(com.tianying.pay.constant.PayConstant.PAY_STATUS_SUCCESS + "",
